<?php
// app/views/admin/orders/aktif.php
...
<nav class="order-tabs">
  ...
  <a href="<?= APP_URL ?>/admin/orders/aktif" class="order-tab active"><i class="fas fa-fire me-1"></i> Order Aktif</a>
  <a href="<?= APP_URL ?>/admin/orders/arsip" class="order-tab"><i class="fas fa-archive me-1"></i> Order Arsip</a>
</nav>

<div class="admin-card">
  <div class="card-head">
    <h5>
      <i class="fas fa-fire me-2" style="color:#D4AF37;"></i>Order Aktif
      <span class="tab-count"><?= count($orders) ?> pesanan</span>
    </h5>
    <p style="font-size:.82rem;color:#999;margin:4px 0 0;">Pesanan yang sedang dalam proses (pending, confirmed, processing, shipped).</p>
  </div>
  <div style="overflow-x:auto;">
    <table class="admin-table">
      ...
      <tbody>
        <?php if(empty($orders)): ?>
        <tr><td colspan="8"><div class="empty-state"><i class="fas fa-inbox"></i>Tidak ada order aktif saat ini.</div></td></tr>
